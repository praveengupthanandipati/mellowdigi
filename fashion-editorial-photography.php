                ...
                <div class="row align-items-center banner-hero">
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-wrap gap-3" data-animate data-delay="320">
                            ...
                            <a href="contact.php" class="btn-hero-cta">Book a Shoot</a>
                        </div>
                    </div>
            ...
            <div class="row g-0 align-items-stretch">
                ...
                <div class="col-lg-6 startup-content">
                    <div class="startup-content-inner">
                        ...
                        <a href="contact.php" class="btn-hero-cta" data-animate data-delay="280">Let's Talk Fashion Photography</a>
                    </div>
                </div>
            </div>
         </section>
